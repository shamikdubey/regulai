...
> = {
  COMPLIANT: { label: "Compliant", color: "#00d4aa", icon: CheckCircle2 },
  PARTIALLY_COMPLIANT: {
    label: "Partially Compliant",
    color: "#f5a623",
    icon: AlertTriangle,
  },
  NON_COMPLIANT: { label: "Non-Compliant", color: "#ff4757", icon: XCircle },
};
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-[#e8ecf2]">
            Compliance Review
          </h1>
              ...
              <div className="space-y-1.5 max-h-56 overflow-y-auto">
                {(historyQ.data ?? []).map((r) => {
                  ...
                  return (
                    <div
                      key={r.id}
                      className="flex items-center justify-between p-2.5 bg-[#0a0c10] border border-[#1f2530] rounded-xl"
                    >
      ...
      <div className="space-y-4 mb-6">
        ...
        <div>
          ...
          {selectedFile ? (
            <div className="flex items-center gap-3 px-4 py-3 bg-[#111318] border border-[rgba(0,212,170,0.3)] rounded-xl">
              <FileText size={16} className="text-[#00d4aa] flex-shrink-0" />
            ...
            <div
              ...
              className={cn(
                ...
                isDragActive
                  ? "border-[#00d4aa] bg-[rgba(0,212,170,0.05)]"
            ...
            >
              ...
              <Upload
                ...
                className={cn(
                  "transition-colors",
                  isDragActive ? "text-[#00d4aa]" : "text-[#2a3040]",
                )}
              />
          ...
          >
            ...
            <div className="bg-[#111318] border border-[#1f2530] rounded-2xl p-5">
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h2 className="text-base font-bold text-[#e8ecf2]">
              ...
              <p className="text-[10px] text-[#4a5568] font-mono mt-2">
            ...
            {reviewResult.findings.length > 0 && (
              <div className="space-y-2">
                <h3 className="text-[10px] font-bold text-[#e8ecf2] uppercase tracking-wider">
                  Findings
                </h3>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <span className="text-xs font-semibold text-[#e8ecf2] truncate">
                          {f.title}
                        </span>
                      </div>
                      {expandedFinding === f.id ? (
                        <ChevronUp
                          size={13}
                          className="text-[#4a5568] flex-shrink-0 ml-2"
                        />
                      ) : (
                        <ChevronDown
                          size={13}
                    ...
                    <AnimatePresence>
                      {expandedFinding === f.id && (
                        ...
                        >
                          <div className="px-4 pb-4 space-y-2 border-t border-[#1f2530] pt-3">
                            <p className="text-xs text-[#8892a4]">
                              {f.description}
                            </p>
                            <div className="flex items-start gap-2">
                              <span className="text-[10px] font-bold text-[#00d4aa] flex-shrink-0 mt-0.5">
                                Recommendation:
                              </span>
                              <p className="text-xs text-[#8892a4]">
                                {f.recommendation}
