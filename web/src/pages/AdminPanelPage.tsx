...
export default function AdminPanelPage() {
  ...
  const toggleUserMutation = useMutation({
    ...
    onSuccess: (data) => {
      toast.success(
        data.is_active
          ? `${data.full_name} activated`
          : `${data.full_name} deactivated`,
      );
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-[#4a5568]">
            System management — accessible to admins only
          </p>
        </div>
        <button
          onClick={() => {
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  },
                  {
                    ...
                    sub: "per query",
                    color:
                      statsQ.data.avg_response_ms < 2000
                        ? "#00d4aa"
                        : "#f5a623",
                  },
                ].map((stat) => (
              ...
              <div className="space-y-2">
                ...
                {(usersQ.data ?? []).map((u) => (
                  ...
                  >
                    ...
                    {/* Actions — guard so admins can't deactivate themselves */}
                    {u.id !== user.id && (
